<?php
    ...
    echo "<h1 style='color:red;'><center>Welcome ".$row1['firstname']." ".$row1['lastname']."</h1></center><br>";
...
<body>
    ...
    <div class="card-body">
        <div class="table responsive">
            ...
            <center>
                If you want to book normal train ticket then 
            <a  href="bookticket.php" target="_blank">Click here</a>
            <br><br>
            If you want to book platform ticket then 
            <a  href="platform.php" target="_blank">Click here</a>
            </center>
