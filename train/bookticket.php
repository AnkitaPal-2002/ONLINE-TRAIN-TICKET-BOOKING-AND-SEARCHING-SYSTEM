...
<html>
    ...
    <link rel="stylesheet" href="style_bookticket.css">
    </head>
    <body>
         ...
         <font face="Arial MT" size="6px" color="white">   <h2>ONLINE TICKET</h2></font>
            <div class="card-container">
                ...
                <div class="card-content">
                    ...
                    <form action="print_ticket.php" method="post" target="_blank">
...
<br><br>
&nbsp;  &nbsp;  &nbsp;  Going To:  
                            <select name="going_to" id="going_to" required>
                              <option value=" ">Choose a station</option>
                              <?php
              $sql1="select * from station";
              $res1=mysqli_query($conn,$sql1);
...
Choose the ticket type:
            <input type="radio" name="ticket_type" value="journey">journey
            <input type="radio" name="ticket_type" value="return">return
            <br><br>
&nbsp; &nbsp;&nbsp;&nbsp; Train Type: Ordinary<br><br><br>
  <center>  <input type="submit" name="submit" value="Book Ticket"><br>
                <br>    </form>
                </div></div>
        </section>
    </center>
